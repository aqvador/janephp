...
class UserDetailsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('createdDate', $data)) {
            ...
            if (false === $date) {
                throw new \InvalidArgumentException(sprintf('Invalid datetime value "%s", expected format "%s".', $data['createdDate'], 'Y-m-d\TH:i:sP'));
            }
        ...
        if (\array_key_exists('lastAccessDate', $data)) {
            ...
            if (false === $date_1) {
                throw new \InvalidArgumentException(sprintf('Invalid datetime value "%s", expected format "%s".', $data['lastAccessDate'], 'Y-m-d\TH:i:sP'));
            }
        ...
        if (\array_key_exists('modifiedDate', $data)) {
            ...
            if (false === $date_2) {
                throw new \InvalidArgumentException(sprintf('Invalid datetime value "%s", expected format "%s".', $data['modifiedDate'], 'Y-m-d\TH:i:sP'));
            }
        ...
        if (\array_key_exists('contractEndDate', $data)) {
            ...
            if (false === $date_3) {
                throw new \InvalidArgumentException(sprintf('Invalid datetime value "%s", expected format "%s".', $data['contractEndDate'], 'Y-m-d\TH:i:sP'));
            }
