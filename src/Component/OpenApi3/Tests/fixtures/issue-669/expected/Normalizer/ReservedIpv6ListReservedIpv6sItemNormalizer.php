...
class ReservedIpv6ListReservedIpv6sItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Jane\Generated\DigitalOcean\Model\ReservedIpv6ListReservedIpv6sItem::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Jane\Generated\DigitalOcean\Model\ReservedIpv6ListReservedIpv6sItem::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Jane\Generated\DigitalOcean\Model\ReservedIpv6ListReservedIpv6sItem();
        ...
        if (\array_key_exists('reserved_at', $data)) {
            ...
            if (false === $date) {
                throw new \InvalidArgumentException(sprintf('Invalid datetime value "%s", expected format "%s".', $data['reserved_at'], 'Y-m-d\TH:i:sP'));
            }
    ...
    {
        return [\Jane\Generated\DigitalOcean\Model\ReservedIpv6ListReservedIpv6sItem::class => false];
    }
}