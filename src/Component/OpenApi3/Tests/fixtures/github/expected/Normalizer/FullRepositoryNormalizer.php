...
class FullRepositoryNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return is_object($data) && get_class($data) === \Github\Model\FullRepository::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('anonymous_access_enabled', $data) && \is_int($data['anonymous_access_enabled'])) {
            $data['anonymous_access_enabled'] = (bool) $data['anonymous_access_enabled'];
        }
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if (!($context['skip_validation'] ?? false)) {
            $this->validate($dataArray, new \Github\Validator\FullRepositoryConstraint());
        }
        return $dataArray;
    }
