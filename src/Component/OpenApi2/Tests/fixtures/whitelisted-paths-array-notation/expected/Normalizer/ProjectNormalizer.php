...
class ProjectNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('over_budget_notification_date', $data)) {
            ...
            if (false === $date) {
                throw new \InvalidArgumentException(sprintf('Invalid date value "%s", expected format "%s".', $data['over_budget_notification_date'], 'Y-m-d'));
            }
        ...
        if (\array_key_exists('starts_on', $data)) {
            ...
            if (false === $date_1) {
                throw new \InvalidArgumentException(sprintf('Invalid date value "%s", expected format "%s".', $data['starts_on'], 'Y-m-d'));
            }
        ...
        if (\array_key_exists('ends_on', $data)) {
            ...
            if (false === $date_2) {
                throw new \InvalidArgumentException(sprintf('Invalid date value "%s", expected format "%s".', $data['ends_on'], 'Y-m-d'));
            }
