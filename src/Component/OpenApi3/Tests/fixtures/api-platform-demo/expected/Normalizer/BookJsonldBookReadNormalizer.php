...
class BookJsonldBookReadNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \ApiPlatform\Demo\Model\BookJsonldBookRead::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \ApiPlatform\Demo\Model\BookJsonldBookRead::class;
    }
    ...
    {
        return [\ApiPlatform\Demo\Model\BookJsonldBookRead::class => false];
    }
}