...
class DatabaseClusterReadNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Jane\Generated\DigitalOcean\Model\DatabaseClusterRead::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Jane\Generated\DigitalOcean\Model\DatabaseClusterRead::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Jane\Generated\DigitalOcean\Model\DatabaseClusterRead();
        ...
        if (\array_key_exists('created_at', $data)) {
            ...
            if (false === $date) {
                throw new \InvalidArgumentException(sprintf('Invalid datetime value "%s", expected format "%s".', $data['created_at'], 'Y-m-d\TH:i:sP'));
            }
        ...
        if (\array_key_exists('ui_connection', $data)) {
            $object->setUiConnection($this->denormalizer->denormalize($data['ui_connection'], \Jane\Generated\DigitalOcean\Model\DatabaseClusterReadUiConnection::class, 'json', $context));
            unset($data['ui_connection']);
        }
        if (\array_key_exists('schema_registry_connection', $data)) {
            $object->setSchemaRegistryConnection($this->denormalizer->denormalize($data['schema_registry_connection'], \Jane\Generated\DigitalOcean\Model\DatabaseClusterReadSchemaRegistryConnection::class, 'json', $context));
            unset($data['schema_registry_connection']);
        }
        if (\array_key_exists('connection', $data)) {
            $object->setConnection($this->denormalizer->denormalize($data['connection'], \Jane\Generated\DigitalOcean\Model\DatabaseClusterReadConnection::class, 'json', $context));
            unset($data['connection']);
        }
        if (\array_key_exists('private_connection', $data)) {
            $object->setPrivateConnection($this->denormalizer->denormalize($data['private_connection'], \Jane\Generated\DigitalOcean\Model\DatabaseClusterReadPrivateConnection::class, 'json', $context));
            unset($data['private_connection']);
        }
        if (\array_key_exists('standby_connection', $data)) {
            $object->setStandbyConnection($this->denormalizer->denormalize($data['standby_connection'], \Jane\Generated\DigitalOcean\Model\DatabaseClusterReadStandbyConnection::class, 'json', $context));
            unset($data['standby_connection']);
        }
        if (\array_key_exists('standby_private_connection', $data)) {
            $object->setStandbyPrivateConnection($this->denormalizer->denormalize($data['standby_private_connection'], \Jane\Generated\DigitalOcean\Model\DatabaseClusterReadStandbyPrivateConnection::class, 'json', $context));
        ...
        if (\array_key_exists('maintenance_window', $data)) {
            $object->setMaintenanceWindow($this->denormalizer->denormalize($data['maintenance_window'], \Jane\Generated\DigitalOcean\Model\DatabaseClusterReadMaintenanceWindow::class, 'json', $context));
    ...
    {
        return [\Jane\Generated\DigitalOcean\Model\DatabaseClusterRead::class => false];
    }
}