...
class DatabaseReplicaReadNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Jane\Generated\DigitalOcean\Model\DatabaseReplicaRead::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Jane\Generated\DigitalOcean\Model\DatabaseReplicaRead::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Jane\Generated\DigitalOcean\Model\DatabaseReplicaRead();
        ...
        if (\array_key_exists('connection', $data)) {
            $object->setConnection($this->denormalizer->denormalize($data['connection'], \Jane\Generated\DigitalOcean\Model\DatabaseReplicaReadConnection::class, 'json', $context));
            unset($data['connection']);
        }
        if (\array_key_exists('private_connection', $data)) {
            $object->setPrivateConnection($this->denormalizer->denormalize($data['private_connection'], \Jane\Generated\DigitalOcean\Model\DatabaseReplicaReadPrivateConnection::class, 'json', $context));
    ...
    {
        return [\Jane\Generated\DigitalOcean\Model\DatabaseReplicaRead::class => false];
    }
}