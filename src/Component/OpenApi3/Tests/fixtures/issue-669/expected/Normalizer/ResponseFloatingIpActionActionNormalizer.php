...
class ResponseFloatingIpActionActionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Jane\Generated\DigitalOcean\Model\ResponseFloatingIpActionAction::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Jane\Generated\DigitalOcean\Model\ResponseFloatingIpActionAction::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Jane\Generated\DigitalOcean\Model\ResponseFloatingIpActionAction();
        ...
        if (\array_key_exists('started_at', $data)) {
            ...
            if (false === $date) {
                throw new \InvalidArgumentException(sprintf('Invalid datetime value "%s", expected format "%s".', $data['started_at'], 'Y-m-d\TH:i:sP'));
            }
        ...
        if (\array_key_exists('completed_at', $data) && $data['completed_at'] !== null) {
            ...
            if (false === $date_1) {
                throw new \InvalidArgumentException(sprintf('Invalid datetime value "%s", expected format "%s".', $data['completed_at'], 'Y-m-d\TH:i:sP'));
            }
    ...
    {
        return [\Jane\Generated\DigitalOcean\Model\ResponseFloatingIpActionAction::class => false];
    }
}