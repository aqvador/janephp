...
class BusinessProcessCancellationRequestedEventNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \PicturePark\API\Model\BusinessProcessCancellationRequestedEvent::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \PicturePark\API\Model\BusinessProcessCancellationRequestedEvent::class;
    }
    ...
    {
        return [\PicturePark\API\Model\BusinessProcessCancellationRequestedEvent::class => false];
    }
}